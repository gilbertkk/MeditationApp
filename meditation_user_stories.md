...
## User stories for Notifictions / Reminders
...
## User stories for sharing the exercises
...
## User story to Integrate Persistent Data
1. As a user, I want my data like login state to persist across sessions so that I don't need to re-enter details every time
    ...
    **Acceptance Criteria:**  
      - Provide a persistence mechanism to remember user preferences across sessions.
...
2. As a user, I want to save my preferences such as dark mode so that the app remembers my settings.
    ...
    **Acceptance Criteria:**  
      - User preferences stay persistent accross sessions.
    
    **Story Points:** [1 points]

## User story to Integrate External API
- As a user, I want to view the latest meditations so that I can enjoy the new ones.

    **Acceptance Criteria:**  
     - The app load the meditation data from API when the app is lauched.
     - User can manually refresh the meditations data from the Home screen.
    
    **Story Points:** [2 points]

## User story to Implement Settings Menu
- As a user, I want to access a settings menu from any screen so that I can adjust preferences at my convenience.

    **Acceptance Criteria:**  
     - The app includes a settings icon in the top right corner of all screens, linking to the settings menu.
